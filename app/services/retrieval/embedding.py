...
# whenever this particular gemini embedding model will give us rate limits we are going to fall back to another model
# during our ingestion
...
def _probe_gemini():
    """Try one embed call to verify Gemini is reachable. Returns model or None.
       checks if API is healthy or not
    """
    try:
